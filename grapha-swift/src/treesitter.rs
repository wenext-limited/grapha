...
// ---------------------------------------------------------------------------
// Image asset reference enrichment
// ---------------------------------------------------------------------------
...
/// Pre-computed byte-offset → line-number index for fast lookups.
struct LineIndex {
    /// Byte offsets where each line starts (line 0 starts at offset 0).
...
impl LineIndex {
    ...
    fn line_at_byte(&self, offset: usize) -> usize {
